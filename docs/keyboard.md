...
- The held ruler keeps a compact total at rest. Signed brackets on the top and
  left axes expose its horizontal week/month leg and vertical life-year leg;
  a zero-length leg and its label disappear.
