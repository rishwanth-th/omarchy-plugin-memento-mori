...
Item {
  ...
  Rectangle {
    ...
    Item {
      // Entrance never rewinds the settled rail. This subordinate tracer
      // travels through lived time and disappears before meeting the actual
      // present marker, which remains stationary and semantically primary.
